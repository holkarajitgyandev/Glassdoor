...
//Page to be displayed before signup
const Home = () => {
  return (
    <>
      ...
      <div className="container flex flex-col md:ml-0 items-center justify-center gap-4 md:gap-10 px-4 md:px-4">
        <div className="hidden md:ml-[-280px] md:flex w-full md:w-[400px] h-auto md:h-[500px]">
          <img src={left} className=" md:ml-[-50px] w-1/3" alt="left" />
          <Signup />
          <img src={right} className="w-1/3" alt="right" />
        </div>
